export const contacts = [
	...
	{
		organisation:
			"Ressortübergreifende Klimagruppe (Senatskanzlei, SenUMBK, SenWEB)",
		branch: "Verwaltung",
		range: "Berlin",
	...
	},
	{
		...
		tags: ["Umwelttechnologie", "Grünflächen", "Städteplanung"],
		description:
			"Die Grün Berlin GmbH ist eine landeseigene Gesellschaft, die für die Entwicklung, Pflege und Verwaltung wichtiger Grün- und Freiflächen in Berlin zuständig ist, wie das Tempelhofer Feld. Sie arbeitet eng mit der Senatsverwaltung für Mobilität, Verkehr, Klimaschutz und Umwelt zusammen, wobei die Verwaltung die strategischen Vorgaben liefert und Grün Berlin die operative Umsetzung übernimmt​.",
	},
	{
		...
		tags: ["Klimaschutz und Klimaanpassung"],
		description:
			"Das InfraLAB ist ein Denkraum und Workshop, der von sechs verschiedenen verwaltungsnahen Akteuren gebildet wird, um mit innovativen Problemlösungsmethoden Visionen für ein nachhaltiges Berlin in der Zukunft zu formulieren.",
	},
	{
	...
	},
	{
		...
		tags: ["Städteplanung"],
		description:
			'Die Tegel Projekt GmbH ist eine landeseigene Gesellschaft, die vom Land Berlin mit der Entwicklung und Verwaltung des ehemaligen Flughafengeländes Tegel beauftragt wurde. Auf dem Gelände entstehen die "Urban Tech Republic," ein Forschungs- und Industriepark für urbane Technologien, und das "Schumacher Quartier," ein neues Wohnviertel. ',
	},
	{
		...
		description:
			"Die IHK Berlin vertritt die Interessen der Berliner Wirtschaft und agiert als Schnittstelle zwischen Unternehmen und Politik. Sie übernimmt hoheitliche Aufgaben wie Prüfungen und setzt sich für eine effiziente und wirtschaftsfreundliche Verwaltung ein, bleibt dabei aber unabhängig von staatlichen Geldern​.",
	},
	{
	...
	},
	{
		...
		tags: ["Umwelttechnologie"],
		description:
			"Sie bieten ein ganzheitliches Pflanzen- und Grünflächenmanagement, einschließlich Bodenfeuchtesensoren und Baumrevitalisierung. Sie bieten auch tiefgreifende Analysen vor Ort an, einschließlich Kostenberechnungen, ökologisch-dendrologischer\nBaubegleitung, baumpflegerische Baubegleitung und Leistungsverzeichnistexte.",
	},
	{
		organisation: "Ansvar",
		branch: "Wirtschaft",
